...
<meta name='theme' content='Khobor' />
<meta name='designer' content='Agil Patria' />
<meta name='theme:designer' content='Agil Patria' />
<meta name='theme:version' content='1.8.2' />
<meta name='keywords' content="sid,opensid sistem informasi desa, web, blog, informasi, website, khobor, desa, kecamatan, kabupaten, indonesia, kampung, <?= $desa['nama_desa']; ?>, <?= $desa['nama_kecamatan']; ?>, <?= $desa['nama_kabupaten']; ?>" />
...
<?php else: ?>
	...
	<meta property="og:image" content="<?= base_url("$this->theme_folder/$this->theme/assets/up.jpg") ?>"/>
<?php endif; ?>
